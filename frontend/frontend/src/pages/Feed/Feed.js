...
class Feed extends Component {
  ...
  finishEditHandler = (postData) => {
    ...
    fetch(url, {
      method: method,
      // Now on client side this have to be change we can't sent image in json format we have to pass image in form data!
      // headers: {
      //   "Content-Type": "application/json",
      // },
      // body: JSON.stringify({
      ...
      // }),
      //instead of setting json data we will directly pass the formData to set image!
      body: formData,
      headers: {
        Authorization: "Bearer " + this.props.token,
      },
